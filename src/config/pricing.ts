...
export const PLANS: PlanDefinition[] = [
  {
    ...
    quotas: {
      ...
      domains: 1,
      creditsPerMonth: 10,
      socialAccountsIncluded: 2,
      publicationsPerMonth: 10,
      brandVoicesIncluded: 1,
      commentsPerMonth: 50,
      commentAiSuggestionsPerMonth: 10,
      historyDays: 14,
      apiAccess: false,
    },
    features: [
      ...
      '10 posts préparés',
      '2 réseaux sociaux connectés (LinkedIn, TikTok, X...)',
      '10 publications ou programmations / mois',
      '50 commentaires synchronisés / mois',
      '10 suggestions IA de réponse',
      '2 illustrations IA',
  ...
  },
  {
    ...
    quotas: {
      ...
      domains: 5,
      creditsPerMonth: 120,
      socialAccountsIncluded: 5,
      publicationsPerMonth: 100,
      brandVoicesIncluded: 1,
      commentsPerMonth: 1000,
      commentAiSuggestionsPerMonth: 250,
      historyDays: 180,
      apiAccess: false,
    },
    features: [
      '1 utilisateur',
      '5 domaines suivis',
      '120 STARS Intelligence Credits (SIC) / mois',
      'Recherches directes & veille continue',
      'Analyses express et approfondies',
      'Thèse et antithèse sourcées',
      '5 comptes sociaux connectés (LinkedIn, TikTok, X, IG, FB)',
      '100 publications / mois',
      '1 000 commentaires / mois',
      '250 suggestions IA de réponse (Copilot)',
      'Classification & sentiment',
      '30 illustrations IA / mois',
  ...
  },
  {
    ...
    quotas: {
      ...
      domains: 15,
      creditsPerMonth: 400,
      socialAccountsIncluded: 12,
      publicationsPerMonth: 400,
      brandVoicesIncluded: 3,
      commentsPerMonth: 4000,
      commentAiSuggestionsPerMonth: 1200,
      historyDays: 730,
      apiAccess: false,
    },
    features: [
  ...
  },
  {
    ...
    quotas: {
      ...
      commentsPerMonth: 20000,
      commentAiSuggestionsPerMonth: 6000,
      historyDays: 1825,
      apiAccess: true,
    },
    features: [
      '10 utilisateurs inclus (+25 € HT/mois par siège supplémentaire)',
      '50 domaines suivis',
      '1 500 STARS Intelligence Credits (SIC) / mois',
      ...
      '20 000 commentaires / mois',
      '6 000 suggestions IA (Copilot)',
      'STARS Crisis Radar & règles de modération',
      'SLA personnalisés & files par équipe',
      '400 illustrations IA / mois',
      '10 STARS Voices',
  ...
  },
  {
    ...
    features: [
      ...
      'Files dédiées & SLA contractuel garanti (99.9%)',
      'Plusieurs entités et filiales',
      'STARS Voices illimitées & ton ultra-personnalisé',
      'Sécurité renforcée (SSO SAML, 2FA forcé, SCIM)',
      'Rétention & archivage sur-mesure',
      'Rapports d’audit & conformité RGPD / IA Act',
      'Accès API illimité & webhooks dédiés',
      'Account Manager dédié & support 24/7',
      'Formation sur-mesure & ateliers stratégiques',
    ],
